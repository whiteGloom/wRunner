...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/wrunner-jquery.js");
/******/ })
/************************************************************************/
/******/ ({
    ...
    var structure = new function () {
      ...
      this.Model.prototype = {
        setLimits: function setLimits(newLimits, auto) {
          var newLimits = newLimits ? newLimits : {}; // If any argument does not fit, it will take a current value.
