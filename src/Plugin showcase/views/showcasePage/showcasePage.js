class SliderExample {
  ...
  _findControllers() {
    ...
    this.$typeControllers = [this.$controllersHolders.eq(1).find('input').eq(0), this.$controllersHolders.eq(1).find('input').eq(1)];
    this.$valueController = this.$controllersHolders.eq(2).find('input');
    this.$minValueController = this.$controllersHolders.eq(3).find('input');
    this.$maxValueController = this.$controllersHolders.eq(4).find('input');
    this.$minLimitController = this.$controllersHolders.eq(5).find('input');
    this.$maxLimitController = this.$controllersHolders.eq(6).find('input');
